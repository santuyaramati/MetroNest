...
import { MapPin, Search, Filter, Heart, Phone, Mail, Calendar } from "lucide-react";
              ...
              <Card key={room.id} className="hover:shadow-lg transition-shadow">
                <div className="relative">
                  ...
                  <Button
                    ...
                    onClick={() => toggleBookmark(room, 'room')}
                  >
                    <Heart
                      size={16}
                      className={isBookmarked(room.id, 'room') ? 'fill-red-500 text-red-500' : ''}
                    />
                  </Button>
                  <Badge 
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-2">
                    ...
                    <ContactModal room={room} type="message">
